...
| Обслуживание (БД логов ЦУС, статистика) |
|---|
| ![Maintenance](c4_dash-demo/10.png) |
...
| **Политики и объекты** | Правила МЭ (с источниками, назначениями, сервисами, приложениями, счетчиком, установкой на узлы), Сетевые объекты, Объекты сервисов, Приложения |
