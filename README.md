...
| Правила МЭ (источники, назначения, сервисы, приложения, установка на узлы) | Сетевые объекты |
|---|---|
| ![Firewall Rules](c4_dash-demo/5.png) | ![Network Objects](c4_dash-demo/6.png) |

| Объекты сервисов | Конфигурация (экспорт, синхронизация, импорт) |
|---|---|
| ![Service Objects](c4_dash-demo/7.png) | ![Configuration](c4_dash-demo/8.png) |

| Обслуживание (БД логов ЦУС, статистика) |
|---|
| ![Maintenance](c4_dash-demo/9.png) |

| Обслуживание (БД логов ЦУС, автоочистка, статистика) |
|---|
| ![Maintenance](c4_dash-demo/9.png) |
...
Самый быстрый способ запустить всё — демо-окружение из предсобранных образов:
